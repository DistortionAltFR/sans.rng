local Players = game:GetService("Players") local LocalPlayer = Players.LocalPlayer local RunService = game:GetService("RunService") local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
local remoteEvent = ReplicatedStorage:WaitForChild("RemoteEvent", 9e9)
local equip = remoteEvent:WaitForChild("Equip", 9e9)
